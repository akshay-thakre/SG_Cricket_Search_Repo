...
const LEGACY_CATEGORIES = [
  {
    ...
    people: [
      ...
      { name: 'Gajendra Agarwal',      role: 'Founding Contributor', tribute: 'A tribute story will be added here.', photo: 'Gajendra_fc_o4xaqe' },
      { name: 'Sheetanshu Srivastava', role: 'Founding Contributor', tribute: 'A tribute story will be added here.', photo: 'sheetu_fc' },
      { name: 'Ahsan Nabi Dar',        role: 'Founding Contributor', tribute: 'A tribute story will be added here.', photo: 'Ahsan_di1dec' },
      { name: 'Abhijeet Joshi',        role: 'Founding Contributor', tribute: 'A tribute story will be added here.', photo: 'Abhijeetjoshi_ccwl8q' },
    ],
  },
  {
    id:               'former-captains',
    ...
    people: [
      { name: 'Gajendra Agarwal',      role: 'Former Captain',           tribute: 'A tribute story will be added here.', photo: 'Gajendra_fc_o4xaqe' },
      { name: 'Sheetanshu Srivastava', role: 'Former Captain',           tribute: 'A tribute story will be added here.', photo: 'sheetu_fc' },
      { name: 'Kapil Arora',           role: 'Former Captain',           tribute: 'A tribute story will be added here.', photo: 'Kapil_FC' },
      { name: 'Kintul Mistry',         role: 'Former & Current Captain', tribute: 'A tribute story will be added here.', photo: 'kintul_FC' },
    ],
  },
  {
    id:               'match-winners',
    ...
    people: [
      { name: 'Vikram Singh Salaria',  role: 'Match Winner', tribute: 'A tribute story will be added here.', photo: 'vicky_mw1_jtjrmz' },
      ...
      { name: 'Ahsan Nabi Dar',        role: 'Match Winner', tribute: 'A tribute story will be added here.', photo: 'Ahsan_di1dec' },
      { name: 'Santhosh Dommety',      role: 'Match Winner', tribute: 'A tribute story will be added here.', photo: 'SanthoshDommety_mw1_qi2jdt' },
      { name: 'Gururaj Banakar',       role: 'Match Winner', tribute: 'A tribute story will be added here.', photo: 'gururaj_banakar_fm4ylt' },
      { name: 'Akhil Kukreja',         role: 'Match Winner', tribute: 'A tribute story will be added here.', photo: 'Akhil_Kukreja_daldps' },
      { name: 'Harsha Sharma',         role: 'Match Winner', tribute: 'A tribute story will be added here.', photo: null },
      { name: 'Arvind Bajaj',          role: 'Match Winner', tribute: 'A tribute story will be added here.', photo: 'arvindbajaj_mw1_cnsduv' },
      { name: 'Vipin Jha',             role: 'Match Winner', tribute: 'A tribute story will be added here.', photo: 'vipin_mw1_mjpav5' },
    ],
  },
  {
    id:               'team-builders',
    ...
    people: [
      { name: 'Gaurav Khandelwal',     role: 'Team Builder', tribute: 'A tribute story will be added here.', photo: 'Gaurav_Khandelwal_xqgfes' },
      ...
      { name: 'Vivek Singh',           role: 'Team Builder', tribute: 'A tribute story will be added here.', photo: 'viveksingh_cc_tfkeyj' },
    ],
  },
  {
    id:               'overseas-risers',
    ...
    people: [
      { name: 'Santhosh Dommety',      role: 'Overseas Riser', tribute: 'A tribute story will be added here.', photo: 'SanthoshDommety_mw1_qi2jdt' },
      { name: 'Gaurav Khandelwal',     role: 'Overseas Riser', tribute: 'A tribute story will be added here.', photo: 'Gaurav_Khandelwal_xqgfes' },
      { name: 'Sheetanshu Srivastava', role: 'Overseas Riser', tribute: 'A tribute story will be added here.', photo: 'sheetu_fc' },
      { name: 'Vivek Bhat',            role: 'Overseas Riser', tribute: 'A tribute story will be added here.', photo: 'vivekbhat_OR_sitksv' },
      { name: 'Akhil Kukreja',         role: 'Overseas Riser', tribute: 'A tribute story will be added here.', photo: 'Akhil_Kukreja_daldps' },
  ...
  },
  {
    ...
    people: [
      ...
      { name: 'Ahsan Nabi Dar',        role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'Ahsan_di1dec' },
      { name: 'Abhijeet Joshi',        role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'Abhijeetjoshi_ccwl8q' },
      ...
      { name: 'Gururaj Banakar',       role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'gururaj_banakar_fm4ylt' },
      { name: 'Akhil Kukreja',         role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'Akhil_Kukreja_daldps' },
      ...
      { name: 'Gaurav Khandelwal',     role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'Gaurav_Khandelwal_xqgfes' },
      ...
      { name: 'Pramod Gururaj',        role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'Pramod_Gururaj_qbmjtg' },
      { name: 'Akshay Thakre',         role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
      { name: 'Mithun Ruikar',         role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'Mithun_Ruikar_fxzdyi' },
      ...
      { name: 'Bharat Bhatta',         role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'BharatBHatta_ifmfqa' },
      { name: 'Kiran Salke',           role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'Kiran_Salke_djzq7b' },
      { name: 'Kshitij Godbole',       role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'KshitijGodbole_gguyds' },
      ...
      { name: 'Logan',                 role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'Logan_j80xc0' },
      ...
      { name: 'Srini Donabanu',        role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
      ...
      { name: 'Bharat Khurana',        role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
      { name: 'Uday Bhaskar',          role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
      { name: 'Vaidy',                 role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
      { name: 'Abhishek Sharma',       role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
      { name: 'Prashray',              role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
      { name: 'Aditya Bhanushali',     role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
      { name: 'Sachin Jawale',         role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
      ...
      { name: 'Jayaraman Sagadevan',   role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: 'ayaraman_sagadevan_fhnrfg' },
      { name: 'Shoaib',                role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
      { name: 'Raghuveer Singh',       role: 'Changi Riser', tribute: 'A tribute story will be added here.', photo: null },
    ],
  },
  {
    ...
    people: [
      ...
      { name: 'Pramod Gururaj',       role: 'Silent Contributor', tribute: 'A tribute story will be added here.', photo: 'Pramod_Gururaj_qbmjtg' },
      { name: 'Vipin Jha',            role: 'Silent Contributor', tribute: 'A tribute story will be added here.', photo: 'vipin_mw1_mjpav5' },
  ...
  },
  {
    ...
    people: [
      ...
      { name: 'Vikram Singh Salaria', role: 'Current Core Player', tribute: 'A tribute story will be added here.', photo: 'vicky_mw1_jtjrmz' },
      { name: 'Pradipta Mishra',      role: 'Current Core Player', tribute: 'A tribute story will be added here.', photo: null },
      { name: 'Gajendra Agrawal',     role: 'Current Core Player', tribute: 'A tribute story will be added here.', photo: 'Gajendra_fc_o4xaqe' },
      { name: 'Vivek Singh',          role: 'Current Core Player', tribute: 'A tribute story will be added here.', photo: 'viveksingh_cc_tfkeyj' },
